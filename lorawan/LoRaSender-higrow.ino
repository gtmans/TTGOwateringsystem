/* LoRaSender-higrow to use with LoRaReceiver-higrow
 * for (ESP32 Dev Module):LilyGO TTGO T-Higrow ESP32-DHT11 Sensor with LilyGO TTGO T-Higrow LoRa Shield - 868MHz
 * sends sensor reading as coded text to LORA T3 LoRa32 oled then waits for confirmation message and goes to sleep
 * Mans Rademaker 2022
 */
