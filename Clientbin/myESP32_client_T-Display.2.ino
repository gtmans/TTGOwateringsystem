/*
  small weather station with 2 external sensors
  display is LilyGO TTGO T-Display V1.1 ESP32 - with 1.14 inch TFT Display
  In Arduino IDE: Boards ESP32 Arduino / TTGO_LoRa32_OLEDV1
  
  https://github.com/gtmans/TTGOwateringsystem
...
//converting String IPServer1 "192.168.2.10" to const IPAddress SServer1(192, 168, 2, 10) for ping.ping
int    dot1 = IPServer1.indexOf   (".");
String P0   = IPServer1.substring (0,dot1);
int    dot2 = IPServer1.indexOf   (".",dot1+1);
String P1   = IPServer1.substring (dot1+1,dot2);
int    dot3 = IPServer1.indexOf   (".",dot2+1);
String P2   = IPServer1.substring (dot2+1,dot3);
String P3   = IPServer1.substring (dot3+1);
int    I0   = P0.toInt();
int    I1   = P1.toInt();
int    I2   = P2.toInt();
int    I3   = P3.toInt();
const  IPAddress SServer1 (I0, I1, I2, I3);
int    dot4 = IPServer2.indexOf   (".");
String P4   = IPServer2.substring (0,dot4);
int    dot5 = IPServer2.indexOf   (".",dot4+1);
String P5   = IPServer2.substring (dot4+1,dot5);
int    dot6 = IPServer2.indexOf   (".",dot5+1);
String P6   = IPServer2.substring (dot5+1,dot6);
String P7   = IPServer2.substring (dot6+1);
int    I4   = P4.toInt();
int    I5   = P5.toInt();
int    I6   = P6.toInt();
int    I7   = P7.toInt();
const  IPAddress SServer2 (I4, I5, I6, I7);
